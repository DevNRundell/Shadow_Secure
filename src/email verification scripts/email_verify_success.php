<html>
    ...
    <head>
        <title>Shadow Secure - Email Verified</title>
        <meta charset="utf-8">
        ...
        <div class="global_container">
            ...
            <div class="row">
                ...
                <div class="full_column">
                    ...
                    <h3 style="color: green;">Your email has been verified!<br></h3>
                
                    <p>
                        Your email have been successfully verified and you may now access your account. Thanks again for using Shadow Secure!<br><br>
